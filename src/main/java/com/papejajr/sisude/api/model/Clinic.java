...
@Entity
@Table(name = "clinics")
@SequenceGenerator(sequenceName = "seq_clinics", name = "ID_SEQUENCE", allocationSize = 1)
public class Clinic implements Serializable, Comparable<Clinic> {
	...
	@Column(nullable = false)
	@Size(min = 5, max = 40, message = "Localization invalid")
	private String localization;

	@Column(nullable = false)
	@Size(min = 5, max = 40, message = "Phone invalid")
	private String phone;

	public Clinic(String name, String localization, String phone) {
		this.name = name;
